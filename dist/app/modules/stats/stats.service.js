...
const getTourStats = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const totalTourByTourTypePromise = tour_model_1.Tour.aggregate([
        ...
        {
            $lookup: {
                from: "tourtypes", // কোন কালেকশনে JOIN করবে
                localField: "tourType", // Tour মডেলের এই ফিল্ডটা
                foreignField: "_id", // tourtypes কালেকশনের কোন ফিল্ডের সাথে ম্যাচ করবে
                as: "type" // JOIN করা ডেটা কোন নামে আসবে
            }
        },
