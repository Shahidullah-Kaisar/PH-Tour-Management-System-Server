...
const updateTour = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    */
    ...
    if (payload.deleteImages && payload.deleteImages.length > 0 && existingTour.images && existingTour.images.length > 0) { //for mongodb update img url
        const restDBImages = existingTour.images.filter(imageUrl => { var _a; return !((_a = payload.deleteImages) === null || _a === void 0 ? void 0 : _a.includes(imageUrl)); }); //delete korte bola img mongodb theke baad dibe tarpor ja thakbe seta restDBImages er moddhe store hobe.. 
        const updatedPayloadImages = (payload.images || [])
            .filter(imageUrl => { var _a; return !((_a = payload.deleteImages) === null || _a === void 0 ? void 0 : _a.includes(imageUrl)); }) // যেগুলো delete করা হচ্ছে → বাদ দিচ্ছে
    ...
    const updatedTour = yield tour_model_1.Tour.findByIdAndUpdate(id, payload, { new: true }); //for cloudinary img deletion after update img..
