...
const createUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const hashedPassword = yield bcrypt_1.default.hash(password, Number(env_1.envVars.BCRYPT_SALT));
...
const getSingleUser = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield user_model_1.User.findById(id).select("-password"); // -password ---> password ta response a dekhabe na..
    return {
        data: user
    };
});
...
const updateUser = (userId, payload, decodeToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (decodeToken.role === user_interface_1.Role.ADMIN && ifUserExist.role === user_interface_1.Role.SUPER_ADMIN) {
        throw new AppError_1.default(401, "You are not authorized");
    }
    if (payload.role) {
        if (decodeToken.role === user_interface_1.Role.USER || decodeToken.role === user_interface_1.Role.GUIDE) {
