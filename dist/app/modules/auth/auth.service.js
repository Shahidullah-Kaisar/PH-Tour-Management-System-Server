...
const credentialsLogin = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const _a = isUserExist.toObject(), { password: pass } = _a, rest = __rest(_a, ["password"]); // for removing password of isUserExist data
    return {
...
const changePassword = (oldPassword, newPassword, decodeToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    user.password = yield bcrypt_1.default.hash(newPassword, Number(env_1.envVars.BCRYPT_SALT));
    user.save();
});
const setPassword = (userId, plainPassword) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const hashedPassword = yield bcrypt_1.default.hash(plainPassword, Number(env_1.envVars.BCRYPT_SALT));
...
const resetPassword = (payload, decodedToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const hashedPassword = yield bcrypt_1.default.hash(payload.newPassword, Number(env_1.envVars.BCRYPT_SALT));
